      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-10">
        {info.map((inf, i) => (
          <Disclosure key={i}>
            {({ open }) => (
              <div className="group">
                <DisclosureButton className="flex flex-col group-hover:bg-[#524fd5] group-focus:bg-[#524fd5] w-full justify-between rounded-2xl lg:rounded-3xl border border-gray-200 px-8 py-10 text-left text-sm font-medium focus:outline-none ">
