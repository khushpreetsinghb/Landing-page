...
const Student = () => {
  return (
    <div className="container mx-auto">
      ...
      <div className="flex flex-col lg:flex-row justify-center lg:justify-between items-center gap-5 py-10 lg:py-20 px-4 lg:px-10">
        <div className="bg-rose-100 rounded-3xl inline-block">
          <img className="rounded-3xl" src="/assets/student.svg" alt="student" />
        </div>
        <div className="flex flex-col gap-5 items-start">
          <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold">Martin Watson</p>
          <div className="flex items-center gap-2">
            <img src="/assets/uk.svg" alt="uk" />
